export const createRgLoader = (fragmentCode, htmlElementName) => {
    class RgWebComponent extends HTMLElement {
        ...
        setupWebGL() {
            ...
            fragmentContent = fragmentContent.replace('#include "fragment.glsl"', fragmentShaderCode);
...
createRgLoader(require('../loaders/loader1/fragment.glsl'), 'rg-wgl-loader');
createRgLoader(require('../loaders/loader2/fragment.glsl'), 'rg-wgl-loader-heart');
